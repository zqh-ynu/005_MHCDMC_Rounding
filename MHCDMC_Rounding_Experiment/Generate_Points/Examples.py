...
def oneResult20():
    ...
    fname_out = "D:\\Myschool\\graduate_school\\02Graduate\\Research\\My paper\\2_Papers\\005_MHCDMC_Rounding\\MHCDMC_Rounding_Experiment\\Algorithm\\result\\oneresultLP.txt"
    ...
    for u in U:
        print(u)
    print('------------------------------------')
    draw_all_elements(U, A, 500, fpath + "\\data\\example\\fig\\oneResultLP.pdf", 1)
